...
class PredioResourceTest {
	...
	@Test
	void cadastrarCondominioTest() throws Exception  {
		
		when(this.predioService.cadastrarPredio(Mockito.<PredioRequestDTO>any())).thenReturn(response);
	...
	@Test
	void getPrediosTest() throws Exception {
		
		when(this.predioService.getPredios()).thenReturn(listResponse);
